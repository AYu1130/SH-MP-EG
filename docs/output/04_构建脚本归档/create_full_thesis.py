...
def add_paragraph_custom(doc, text, first_line_indent=True, fontsize=12, bold=False):
    p = doc.add_paragraph()
    run = p.add_run(text)
    run.font.name = '宋体'
...
def add_code_block(doc, code_lines, caption=None):
    ...
    shading_xml = r'<w:shd {} w:fill="F2F2F2" w:color="auto" w:val="clear"/>'.format(qn('xmlns:w'))
...
abstract_paras = [
    ...
    '本研究采用系统设计与实验验证相结合的方法，基于树莓派和ESP32等硬件平台，设计了一套支持Wi-Fi、BLE与MQTT协议的软件系统[2]，并实现了协议适配、消息路由及本地联动等功能。系统采用四层分层架构设计，参照ETSI MEC参考架构[3]，实现了边缘侧数据处理和本地自治决策。通过对Wi-Fi、BLE、MQTT三种典型协议的融合实践，丰富了异构网络互联的理论体系[4]。',
    
    '通过搭建真实测试环境，对网关的功能完整性、传输时延及断网恢复能力进行了全面测试。结果表明：Wi-Fi传输时延平均值45.2ms，BLE时延平均值78.6ms，跨节点联动响应时延平均136.2ms[5]，均满足设计指标要求。系统在7×24小时长时运行测试中保持稳定运行，断网恢复能力测试补传成功率达到100%。',
    
    '本研究形成的软硬件参考架构能为嵌入式工程师、智能家居系统集成商提供具体、可复现的设计方案[6]。该方案在网关侧实现协议转换与本地联动规则引擎，本地控制响应时间控制在500毫秒以内，MQTT端到端传输延迟不超过200毫秒，在网络中断场景下依靠本地规则引擎仍能维持智能联动功能的正常运行[7]。',
...
abstract_en_paras = [
    'With the rapid development of smart home and Internet of Things technology, the interconnection of multi-protocol devices has become a bottleneck restricting the improvement of user experience[1]. Traditional single-protocol or cloud-centric processing solutions are difficult to balance low latency, high compatibility, and local autonomy requirements. This paper aims to design and implement a multi-protocol edge intelligent gateway for smart home scenarios to solve the problems of heterogeneous device access difficulties and low collaboration efficiency.',
    
    'This research adopts a method combining system design and experimental verification, and designs a software system supporting Wi-Fi, BLE and MQTT protocols based on hardware platforms such as Raspberry Pi and ESP32[2], and implements protocol adaptation, message routing and local linkage functions. The system adopts a four-layer hierarchical architecture design, referring to the ETSI MEC reference architecture[3], and realizes edge-side data processing and local autonomous decision-making.',
    
    'By building a real test environment, the functional integrity, transmission delay and network disconnection recovery capability of the gateway were comprehensively tested. The results show that the average Wi-Fi transmission delay is 45.2ms, the BLE delay is 78.6ms, and the cross-node linkage response delay is 136.2ms on average[5], all meeting the design index requirements. The system maintained stable operation during the 7×24-hour long-term running test, and the relay success rate reached 100% in the network disconnection recovery capability test.',
...
toc_items = [
    ...
    '    3.1.2 系统数据流架构........................................................... 17',
    '  3.2 硬件平台设计与实现............................................................. 18',
    '    3.2.1 核心主控硬件选型：树莓派4B............................................... 18',
    '    3.2.2 Wi-Fi终端节点：ESP32-S3.................................................. 19',
    '    3.2.3 BLE终端节点：STM32F103.................................................. 20',
    '    3.2.4 硬件系统实物图........................................................... 21',
    '  3.3 软件平台搭建与运行环境配置..................................................... 22',
    ...
    '    4.3.1 Wi-Fi终端接入模块........................................................ 28',
    '    4.3.2 BLE终端接入模块.......................................................... 30',
    '  4.4 协议转换与消息路由模块设计实现................................................. 32',
    '  4.5 本地自治联动与离线补传机制实现................................................. 35',
    '  4.6 设备管理与状态管理功能实现..................................................... 38',
    '第5章 多协议边缘网关系统测试与验证.................................................... 41',
    '  5.1 测试环境与测试方案............................................................. 41',
    '  5.2 系统功能测试与结果分析......................................................... 43',
    '  5.3 系统性能测试与结果分析......................................................... 45',
    '  5.4 系统稳定性测试与结果分析....................................................... 48',
...
print("封面、摘要、目录部分生成完成")

# 保存第一批
doc.save('e:\\100_study\\120_Project\\CapstoneProject\\SmartHome_MultiProtocol_EdgeIntelligent_Gateway\\SH-MP-EG\\docs\\output\\面向智能家居的多协议边缘智能网关设计_完整版_部分1.docx')
print("部分1保存完成")
