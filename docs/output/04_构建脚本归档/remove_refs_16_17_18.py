...
def main():
    ...
    # 摘要 - 移除[16,17,18]引用，改为[1-15]中的引用
    ...
    # 保存第一批
    doc.save('e:\\100_study\\120_Project\\CapstoneProject\\SmartHome_MultiProtocol_EdgeIntelligent_Gateway\\SH-MP-EG\\docs\\output\\面向智能家居的多协议边缘智能网关设计_去除16_17_18_部分1.docx')
    print("部分1保存完成")
